...
class Application extends javax.swing.JFrame implements Publisher {
	...
	public void run() {
		...
		/*
		EmailAccount email1 = new EmailAccount("therock", "yahoo.com", broker);
		email1.subscribe("test1");
		EmailAccount email2 = new EmailAccount("dwaynejohnson", "aol.com", broker);
		email2.subscribe("test1");
		email2.subscribe("test2");
		inventory.publish(broker, new Message("test1", "message 1"));
		inventory.publish(broker, new Message("test2", "message 2"));
		email2.unsubscribe("test2");
